...
import 'package:merchant_app/Models/placePredictions.dart';
...
class _SearchScreenState extends State<SearchScreen> {
                  ...
                  children: [
                    ...
                    Stack(
                      children: [
                        ...
                        Center(
                          child: Text("Set Customer's Location", style: TextStyle(fontSize: 18.0),),
                        ),
                      ],
                    ),
  ...
  void findPlace(String placeName) async {
    if(placeName.length>1){
      String  autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:lb";
...
class  PredictionTile extends StatelessWidget {
  ...
  void getPlaceAddressDetails(String placeId, context) async{
    showDialog(
      context: context,
      builder: (BuildContext context) => ProgressDialog(message: "loading DropOff, please wait..",)
    );
